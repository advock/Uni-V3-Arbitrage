...
pub mod uni_v3_factory {
    const _: () = {
        ::core::include_bytes!(
            "/Users/advock/Rizzolver/EThDexMev/src/abi/UniV3Factory.json",
        );
    };
    #[allow(deprecated)]
    ...
    pub static UNIV3FACTORY_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(
        __abi,
    );
