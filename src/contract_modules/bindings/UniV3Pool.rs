...
pub mod uni_v3_pool {
    const _: () = {
        ::core::include_bytes!(
            "/Users/advock/Rizzolver/EThDexMev/src/abi/UniswapV3Pool.json",
        );
    };
    #[allow(deprecated)]
    ...
    pub static UNIV3POOL_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(
        __abi,
    );
    ...
    impl<M> ::core::fmt::Debug for UniV3Pool<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(UniV3Pool)).field(&self.address()).finish()
        }
    }
    ...
    impl ::ethers::contract::EthLogDecode for UniV3PoolEvents {
        fn decode_log(
            ...
            if let Ok(decoded) = IncreaseObservationCardinalityNextFilter::decode_log(
                ...
                return Ok(
                    UniV3PoolEvents::IncreaseObservationCardinalityNextFilter(decoded),
                );
            }
